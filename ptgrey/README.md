...
Disclaimer:this package is a slight modification from the original driver written by GaoWenLiang, the only difference is that it will automatically start the hardware trigger function of the N3 from DJI via the DJI OSDK
